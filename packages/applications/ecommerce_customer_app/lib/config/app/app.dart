  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (_) => ProductsInCartCubit(
            addProductToCartUseCase: GetIt.instance.get(),
            getProductListInCartUseCase: GetIt.instance.get(),
            removeProductFromCartUseCase: GetIt.instance.get(),
          ),
        ),
      ],
